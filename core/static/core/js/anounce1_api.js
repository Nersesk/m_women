      ...
      anounceinfotext_contacts.addEventListener("click", () => {
        ...
        announc.required_files.forEach((item) => {
          ...
          file.addEventListener("click", () => {
            let url = `https://xn--29ae4dgic.xn--y9a3aq${item.url}`;
